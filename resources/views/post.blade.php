...
@section('content')
    <div class="header-bg">
        <div class="display-table  center-text">
            <h1 style="color: #f0f0ee" class="title display-table-cell"><b>{{ $post->title }}</b></h1>
        </div>
    </div><!-- slider -->
                ...
                <div class="col-lg-8 col-md-12 no-right-padding">
                    ...
                    <div class="main-post">
                        ...
                        <div class="blog-post-inner">
                            ...
                            <div class="post-image"><img src="{{asset('public/storage/post/'.$post->image)}}" alt="Blog Image"></div>
                        ...
                        <div class="post-icons-area">
                            <ul class="post-icons">
                                <li>
                                    ...
                                    @else
                                        <a href="javascript:void(0);" onclick="document.getElementById('favorite-form-{{ $post->id }}').submit();" class="{{ !Auth::user()->favorite_posts->where('pivot.post_id',$post->id)->count() == 0 ? 'favorite_posts' : '' }}"><i class="ion-heart"></i>{{ $post->favorite_to_users->count() }}
                                        </a>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card h-100">
                            <div class="single-post post-style-1">
                                ...
                                <a class="avatar" href="#"><img src="{{asset('public/storage/profile/'.$randompost->user->image)}}" alt="Profile Image"></a>
                                ...
                                <div class="blog-info">
                                    ...
                                    <ul class="post-footer">
                                        <li>
                                            ...
                                            @else
                                                <a href="javascript:void(0);" onclick="document.getElementById('favorite-form-{{ $randompost->id }}').submit();" class="{{ !Auth::user()->favorite_posts->where('pivot.post_id',$randompost->id)->count() == 0 ? 'favorite_posts' : '' }}"><i class="ion-heart"></i>{{ $randompost->favorite_to_users->count() }}
                                                </a>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-12">
                    <div class="comment-form">
                        @guest()
                            <p>
                                For post a new comment. You need to login first. Please <a style="color: #0D47A1;" href="{{ route('login') }}"> Login</a>
                            </p>
                        @else
