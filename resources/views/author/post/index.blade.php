        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            ALL POST <span style="padding: 8px;" class="badge bg-blue">{{ $posts->count() }}</span>
                        </h2>
                                ...
                                @foreach($posts as $key=>$post)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-info waves-effect" href="{{ route('author.post.show',$post->id) }}"><i class="material-icons">visibility</i></a>
                                            <a class="btn btn-info waves-effect" href="{{ route('author.post.edit',$post->id) }}"><i class="material-icons">edit</i></a>
